      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="prose prose-sm max-w-none text-[#3C4536] space-y-6 text-sm leading-relaxed border-t border-[#E7EAE1] pt-8">
          <section className="space-y-3">
            <h2 className="text-base font-bold text-[#13251C]">1. Introduction</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-bold text-[#13251C]">2. Information We Collect</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-bold text-[#13251C]">3. How We Use Data</h2>
            <p>
