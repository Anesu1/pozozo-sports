    ...
    <div className="py-16 sm:py-24 bg-white min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="prose prose-sm max-w-none text-[#3C4536] space-y-6 text-sm leading-relaxed border-t border-[#E7EAE1] pt-8">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-bold text-[#13251C]">2. Order Processing</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-bold text-[#13251C]">4. Shipping Costs</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-bold text-[#13251C]">5. Tracking Your Order</h2>
            <p>
